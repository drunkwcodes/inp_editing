...
def take_4():
    ...
    session.Viewport(name='Viewport: 1', origin=(0.0, 0.0), width=177.674987792969, 
    ...
    mdb.ModelFromInputFile(name='test', 
        inputFileName='D:/projects/inp_editing/test.inp')
    ...
    mdb.models['test'].HomogeneousSolidSection(name='Section-1', material='FR4', 
        thickness=None)
    p = mdb.models['test'].parts['PART-1']
    e = p.elements
    elements = e.getSequenceFromMask(mask=('[#ffffffff:320 #3fffffff ]', ), )
    ...
    p = mdb.models['test'].parts['PART-1']
    e = p.elements
    elements = e.getSequenceFromMask(mask=('[#0:123 #3fc00 #3fc000 ]', ), )
